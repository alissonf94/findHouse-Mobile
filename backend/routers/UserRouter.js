...
UserRouter.route("/user/interest").put((req, res, next) => UserController.addInterestController(req, res, next))
UserRouter.route("/user/favorites").put((req, res, next) => UserController.addFavoritesController(req, res, next))
UserRouter.route("/user/favorites").get((req, res, next) => UserController.findByUserFavoritesController(req, res, next))
UserRouter.route("/user/favorites").delete((req, res, next) => UserController.deleteImmobileFavoriteService(req, res, next))
